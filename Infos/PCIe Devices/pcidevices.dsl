DefinitionBlock ("", "SSDT", 2, "HACK", "PCI", 0x00000000)
{
	...
	External (_SB_.PCI0.BXBR.BYUP.BYD1, DeviceObj)
	Device (_SB.PCI0.BXBR.BYUP.BYD1)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				...
				"device_type", Buffer () { "PCI bridge" },
				"AAPL,slot-name", Buffer () { "Internal@0,1,2/0,0/1,0" },
			})
		}
	}
	...
	External (_SB_.PCI0.BXBR.BYUP.BYD1.BYS1, DeviceObj)
	Device (_SB.PCI0.BXBR.BYUP.BYD1.BYS1)
	{
		Name (_ADR, 0x00000000)
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "DeckLink Mini Monitor 4K" },
				"device_type", Buffer () { "Multimedia video controller" },
				"AAPL,slot-name", Buffer () { "Internal@0,1,2/0,0/1,0/0,0" },
			})
		}
	}
	...
	External (_SB_.PCI0.BXBR.BYUP.BYD8.SHCI, DeviceObj)
	Device (_SB.PCI0.BXBR.BYUP.BYD8.SHCI)
	{
	...
	Device (_SB.PCI0.GPP8.SWUS.SWDS)
	{
		Name (_ADR, 0x00000000)
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				...
				"device_type", Buffer () { "PCI bridge" },
				"AAPL,slot-name", Buffer () { "Internal@0,3,1/0,0/0,0" },
			})
		}
	}
	External (_SB_.PCI0.GPP8.SWUS.SWDS.GFX0, DeviceObj)
	Device (_SB.PCI0.GPP8.SWUS.SWDS.GFX0)
	{
		Name (_ADR, 0x00000000)
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				...
				"AAPL,slot-name", Buffer () { "Internal@0,3,1/0,0/0,0/0,0" },
			})
		}
	}
	External (_SB_.PCI0.GPP8.SWUS.SWDS.HDAU, DeviceObj)
	Device (_SB.PCI0.GPP8.SWUS.SWDS.HDAU)
	{
		Name (_ADR, 0x00000001)
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				...
				"device_type", Buffer () { "Audio device" },
				"AAPL,slot-name", Buffer () { "Internal@0,3,1/0,0/0,0/0,1" },
			})
		}
	}
}
